...
"[project]/web/app/api/test-files/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function walk(dir) {
    ...
    return entries.flatMap((e)=>e.isDirectory() ? walk(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(dir, e.name)) : [
            __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(dir, e.name)
        ]);
}
async function GET() {
    try {
        const allFiles = walk(__TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$paths$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TESTS_GENERATED_DIR"]).filter((f)=>f.endsWith('.spec.ts'));
        const files = allFiles.map((abs)=>{
            const stat = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].statSync(abs);
            return {
                path: abs,
                name: __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].basename(abs),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1313bus._.js.map