...
function runPlaywright(filePath, headed) {
    return new Promise((resolve, reject)=>{
        ...
        const pwBin = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(__TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$paths$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["OTOTEST_ROOT"], 'node_modules', '.bin', 'playwright');
        const args = [
            'test',
            filePath,
            '--project=chromium'
        ...
        const proc = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$child_process__$5b$external$5d$__$28$child_process$2c$__cjs$29$__["spawn"])(pwBin, args, {
...
"[project]/web/app/api/test-files/jobs/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, { params }) {
    ...
    const job = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$lib$2f$test$2d$runner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getJob"])(id);
    if (!job) return __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Job bulunamadı.'
    }, {
        status: 404
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(job);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__092k4g9._.js.map