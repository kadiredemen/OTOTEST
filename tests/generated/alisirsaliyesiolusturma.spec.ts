...
// Plan: recordings\alisirsaliyesiolusturma-plan.json
test.describe('Alisirsaliyesiolusturma', () => {
  test('Alisirsaliyesiolusturma akisi', async ({ page }) => {
